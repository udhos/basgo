...
30310 locate bandity(i), banditx(i): print "#";
30320 next
30330 return
...
30510 gosub 30600
30520 if planetx(p)<banditx(i) then gosub 30700:banditx(i)=banditx(i)-1: goto 30590
30530 if planety(p)<bandity(i) then gosub 30700:bandity(i)=bandity(i)-1: goto 30590
30540 if planetx(p)>banditx(i) then gosub 30700:banditx(i)=banditx(i)+1: goto 30590
30550 if planety(p)>bandity(i) then gosub 30700:bandity(i)=bandity(i)+1: goto 30590
30590 next
30599 return
