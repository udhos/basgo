...
3730 PRINT "SPACE THAT IS ADJACENT TO ONE - AND ONLY ON E EXISTING"
...
4220 PRINT "POSSESSION ), AND OFFERS HIM THE OPPOR TUNITY TO PURCHASE"
...
4290 PRINT "THE NUMBER OF SHARES OWNED BY THAT PLAYER IS DOUBLED."
4300 PRINT 
