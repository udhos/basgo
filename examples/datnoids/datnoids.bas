...
340 SOUND 32767,.1:LOCATE 23,28:COLOR 0,7:PRINT" BOOGERS! BY MITCH TEICH ":SOUND 32767,.1:PRINT STRING$(80,"["):LOCATE 24,31:PRINT"(C) COPYRIGHT 1982":COLOR 7,0:PLAY"c8c8e8gc8c8e8gf8e8d8g8g8g8g"::PLAY"MB":DIM MZ(22,80)
350 up1$="A":up2$="a":down1$="Z":down2$="z":kleft1$=",":kleft2$="<":kright1$=".":kright2$=">":blam1$=";":blam2$=":"
400 DEF SEG=0:POKE 1050,PEEK(1052):CLS:LOCATE 10,21:INPUT"PLEASE ENTER YOUR SKILL LEVEL (1-10)";SK:IF SK<1 OR SK>10 THEN CLS:BEEP:LOCATE 10,63:PRINT"ERROR":GOTO 400
...
470 CLS:PLAY"mb":B$=CHR$(219):LOCATE 10,35:PRINT"please wait...":FOR LS=1 TO 20:FOR SL=2 TO 79:MZ(LS,SL)=1:NEXT:NEXT:LOCATE 10,35:PRINT"              ":COLOR 0,7:LOCATE 25,16:PRINT" F1=QUIT  ";up1$;"=UP  ";down1$;"=DOWN  ";kleft1$;"=LEFT  ";kright1$;"=RIGHT  ";blam1$;"=BLAMMO! ":COLOR 7,0
...
550 LOCATE 4,2:PRINT CHR$(221):LOCATE 6,2:PRINT CHR$(221):LOCATE 23,4,0:PRINT"0 SCORE =                   0000000000000000000 LEVEL   "+STR$(TK)+"  00  MAZE "+LEV$+"  000":S$=STRING$(75,176):LOCATE 24,4,0:PRINT "&";S$
...
670 COLOR 15,0:LOCATE 19,72:PRINT CH$:COLOR 1,0:LOCATE 20,72:PRINT"J":PLAY"MF":FOR R=1 TO 600 STEP 10:SOUND 1000+R,.1:SOUND 3000+R*1.5,.1:NEXT:FOR R=1 TO 3:SOUND 32767,10:BEEP:NEXT:PLAY"MB":DEF SEG=0:POKE 1050,PEEK(1052)
...
750 LOCATE X,Y:PRINT CH$:SOUND 32767,.05:FOR P=1 TO SK:NEXT:AXN$=INKEY$:IF AXN$=up1$ OR AXN$=up2$ THEN GOSUB 1070
762 IF AXN$=down1$ OR AXN$=down2$ THEN GOSUB 950
763 IF AXN$=kleft1$ OR AXN$=kleft2$ THEN GOSUB 890
764 IF AXN$=kright1$ OR AXN$=kright2$ THEN GOSUB 1010
765 IF AXN$=blam1$ OR AXN$=blam2$ THEN GOSUB 1260:GOTO 770
...
810 AXN$=INKEY$:IF AXN$=up1$ OR AXN$=up2$ THEN GOSUB 1070
820 IF AXN$=down1$ OR AXN$=down2$ THEN GOSUB 950
830 IF AXN$=kleft1$ OR AXN$=kleft2$ THEN GOSUB 890
840 IF AXN$=kright1$ OR AXN$=kright2$ THEN GOSUB 1010
850 IF AXN$=blam1$ OR AXN$=blam2$ THEN GOSUB 1260:GOTO 770
...
1450 PLAY"mb":FOR T=100 TO 10000 STEP 100:SOUND T,.1:SOUND 10100-T,.1:NEXT:SOUND 37,18
